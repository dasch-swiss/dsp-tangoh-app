				...
				var property_changed = function(ele, prop_id) {
					...
					switch (datatype) {
						...
						case VALTYPE_TEXT: { // we use gui_element = "text"
							compop.append($('<option>', {'value': 'LIKE', 'title': 'like'}).append(strings._like));
							compop.append($('<option>', {'value': 'EQ', 'title': 'equal'}).append(strings._equal));
							compop.append($('<option>', {'value': 'MATCH', 'title': 'match'}).append(strings._match));
							compop.append($('<option>', {'value': 'EXISTS', 'title': 'exists'}).append(strings._exists));
							compop.append($('<option>', {'value': 'MATCH_BOOLEAN', 'title': 'match boolean'}).append(strings._match_boolean));
							compop.append($('<option>', {'value': '!EQ', 'title': 'not equal'}).append(strings._not_equal));
							compop.append($('<option>', {'value': '!LIKE', 'title': 'not like'}).append(strings._not_like));
						...
						case VALTYPE_INTEGER: { // we use gui_element = "text"
							compop.append($('<option>', {'value': 'EQ', 'title': 'equal'}).append(strings._equal));
							compop.append($('<option>', {'value': 'EXISTS', 'title': 'exists'}).append(strings._exists));
							compop.append($('<option>', {'value': 'GT', 'title': 'greater than'}).append(strings._greater_than));
							compop.append($('<option>', {'value': 'GT_EQ', 'title': 'greater equal than'}).append(strings._greater_equal_than));
							compop.append($('<option>', {'value': 'LT', 'title': 'less than'}).append(strings._less_than));
							compop.append($('<option>', {'value': 'LT_EQ', 'title': 'less equal than'}).append(strings._less_equal_than));
							compop.append($('<option>', {'value': '!EQ', 'title': 'not equal'}).append(strings._not_equal));
				...
				.append($('<div>').addClass('center').append($('<input>').attr({'type': 'button', 'value': strings._search}).addClass('center').on('click', function(event) {
					...
					property_id_ele.each(function(index) {
						...
						switch (gui_element) {
							...
							case 'checkbox': {
								searchval.push($(searchval_ele[index]).is(':checked'));
								break;
							}
							default: {
